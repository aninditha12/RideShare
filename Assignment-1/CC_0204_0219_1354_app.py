...
def create_ride():
	...
	to_chk = requests.post('http://127.0.0.1:5000/api/v1/db/read', json={'table_name':'User','db_action':'check','db_data':req["created_by"]})
...
def join_ride(rideid):
	...
	to_chkUser=requests.post('http://127.0.0.1:5000/api/v1/db/read', json={'table_name':'User','db_action':'check','db_data':req["username"]})
	if(to_chkRide.text=="NA"):
